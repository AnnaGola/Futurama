...
struct DailyTableViewCellModel {
...
final class DayCell: UITableViewCell {
    ...
    func configureTableViewCellViewModelFor(_ index: Int) -> DailyTableViewCellModel {
        ...
        if let weatherModel =  weatherModel {
            ...
            iconImageView.downloadedData(from: urlString ?? "")
        ...
        return DailyTableViewCellModel(
    ...
    func configure(with viewModel: DailyTableViewCellModel) {
